...
<link rel="apple-touch-icon" href="../filesToUnderstand/icon.png">
```
...
```html
<link rel="apple-touch-startup-image" media="(max-device-width: 480px) and (-webkit-min-device-pixel-ratio: 2)" href="src/assets/images/startup.png">
```
